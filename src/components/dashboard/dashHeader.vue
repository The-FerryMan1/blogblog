...
<template>
    ...
    <div class="w-[95%] bg-transparent shadow-sm  flex py-2 justify-center items-center">
        <div class="flex border-2 w-full border-slate-800 p-3 justify-between items-center rounded-lg">
            ...
            <button @click="OpenS" class="bg-blue-600 py-3 px-3 ms-10 rounded-lg w-[1/3] hover:bg-blue-300 flex gap-3 text-white"><img
