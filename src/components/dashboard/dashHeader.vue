...
<template>
    ...
    <div class="w-[95%] bg-transparent flex py-2 justify-center items-center">
        <div class="flex bg-white w-full  p-3 justify-between items-center rounded-lg">
            <div class="flex ">
                ...
                <div class="flex flex-col justify-start">
                    <p class="text-lg font-semibold">{{ auth.user?.displayName ? auth.user?.displayName :
                        auth.user?.email }}</p>
            ...
            <button @click="OpenS"
                class="bg-blue-600 py-3 px-3 ms-10 rounded-lg w-[1/3]   hover:bg-blue-300 flex gap-3 text-white"><img
